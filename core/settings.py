...
SECRET_KEY = "django-insecure-8pn0s9d=uq7phl5c$u4kivprx0!-qr85vbon5pxh6^h*$85x@9"
...
# Static files (CSS, JavaScrpipt, Images)
...
JAZZMIN_SETTINGS = {
    ...
    # Relative path to a favicon for your site, will default to sitxe_logo if absent (ideally 32x32 px)
